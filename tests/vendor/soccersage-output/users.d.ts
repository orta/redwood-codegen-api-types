...
export interface UsersResolver {
  (args: {}, obj: { root: {}, context: RedwoodGraphQLContext, info: GraphQLResolveInfo }): RTUser[] | Promise<RTUser[]> | (() => Promise<RTUser[]>);
}

/** SDL: user(id: Int!): User */
export interface UserResolver {
  (args: { id: number }, obj: { root: {}, context: RedwoodGraphQLContext, info: GraphQLResolveInfo }): RTUser | null | Promise<RTUser | null> | (() => Promise<RTUser | null>);
}

/** SDL: createUser(input: CreateUserInput!): User! */
export interface CreateUserResolver {
  (args: { input: CreateUserInput }, obj: { root: {}, context: RedwoodGraphQLContext, info: GraphQLResolveInfo }): RTUser | Promise<RTUser> | (() => Promise<RTUser>);
}

/** SDL: updateUser(id: Int!, input: UpdateUserInput!): User! */
export interface UpdateUserResolver {
  (args: { id: number, input: UpdateUserInput }, obj: { root: {}, context: RedwoodGraphQLContext, info: GraphQLResolveInfo }): RTUser | Promise<RTUser> | (() => Promise<RTUser>);
}

/** SDL: deleteUser(id: Int!): User! */
export interface DeleteUserResolver {
  (args: { id: number }, obj: { root: {}, context: RedwoodGraphQLContext, info: GraphQLResolveInfo }): RTUser | Promise<RTUser> | (() => Promise<RTUser>);
}

/** SDL: sendResetPasswordEmail(email: String!): SuccessInput */
export interface SendResetPasswordEmailResolver {
  (args: { email: string }, obj: { root: {}, context: RedwoodGraphQLContext, info: GraphQLResolveInfo }): RTSuccessInput | null | Promise<RTSuccessInput | null> | (() => Promise<RTSuccessInput | null>);
}

/** SDL: resetPassword(password: String!, resetToken: String!): User! */
export interface ResetPasswordResolver {
  (args: { password: string, resetToken: string }, obj: { root: {}, context: RedwoodGraphQLContext, info: GraphQLResolveInfo }): RTUser | Promise<RTUser> | (() => Promise<RTUser>);
}
