...
export interface StandingsResolver {
  (args: { seasonId: number }, obj: { root: {}, context: RedwoodGraphQLContext, info: GraphQLResolveInfo }): RTStandingsResult | null | Promise<RTStandingsResult | null> | (() => Promise<RTStandingsResult | null>);
}

/** SDL: predictions: [Prediction!]! */
export interface PredictionsResolver {
  (args: {}, obj: { root: {}, context: RedwoodGraphQLContext, info: GraphQLResolveInfo }): RTPrediction[] | Promise<RTPrediction[]> | (() => Promise<RTPrediction[]>);
}
...
export interface PredictionResolver {
  (args: { id: number }, obj: { root: {}, context: RedwoodGraphQLContext, info: GraphQLResolveInfo }): RTPrediction | null | Promise<RTPrediction | null> | (() => Promise<RTPrediction | null>);
}

/** SDL: createPrediction(input: CreatePredictionInput!): Prediction! */
export interface CreatePredictionResolver {
  (args: { input: CreatePredictionInput }, obj: { root: {}, context: RedwoodGraphQLContext, info: GraphQLResolveInfo }): RTPrediction | Promise<RTPrediction> | (() => Promise<RTPrediction>);
}

/** SDL: updatePrediction(id: Int!, input: UpdatePredictionInput!): Prediction! */
export interface UpdatePredictionResolver {
  (args: { id: number, input: UpdatePredictionInput }, obj: { root: {}, context: RedwoodGraphQLContext, info: GraphQLResolveInfo }): RTPrediction | Promise<RTPrediction> | (() => Promise<RTPrediction>);
}

/** SDL: deletePrediction(id: Int!): Prediction! */
export interface DeletePredictionResolver {
  (args: { id: number }, obj: { root: {}, context: RedwoodGraphQLContext, info: GraphQLResolveInfo }): RTPrediction | Promise<RTPrediction> | (() => Promise<RTPrediction>);
}
