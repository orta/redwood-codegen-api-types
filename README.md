...
Redwood's type generation is pretty reasonable for most projects, but I've found after ~15 months of using Redwood after turning on TypeScript's script mode, I've never once got to 0 compiler warnings.
