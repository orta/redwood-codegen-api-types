...
export * as graphql from "npm:graphql@^16.5";
// export * as watchman from "npm:fb-watchman@2.0.2";

export type { Node } from "npm:typescript@^5.0";
export { getSchema as getPrismaSchema } from "npm:@mrleebo/prisma-ast@0.5.2";
export type { Model as PrismaModel, Property as PrismaProperty, Schema as PrismaSchemaBlocks } from "npm:@mrleebo/prisma-ast@0.5.2";
